...
def createMethod(methodName, methodDesc, rootDesc, schema): # -> tuple[Any | str, Callable[..., Any]]:
...
def createNextMethod(methodName, pageTokenName=..., nextPageTokenName=..., isPageTokenParameter=...): # -> tuple[Any | str, Callable[..., Any | None]]:
